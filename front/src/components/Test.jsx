...
const Test = () => {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === "preparation" || name === "repos" || name === "cook") {
      return setRecipeData((prevRecipe) => ({ ...prevRecipe, time: { ...prevRecipe.time, [name]: value } }))
    }
  ...
  const handleProfileChange = (e) => {
    ...
    console.log(checked)
    setRecipeData((prevRecipe) => ({ ...prevRecipe, profile: { ...prevRecipe.profile, [name]: checked, } }))
  };
  ...
  const addIngredient = (e) => {
    ...
    setRecipeData({
      ...recipeData,
      ingredients: [...recipeData.ingredients, { amount: 0, ingredient: '', unit: '' }]
    })
  };
  ...
  return (
    <form onSubmit={handleSubmit} method="post" encType='multipart/form-data'>
      ...
      <div>
        ...
        <select name="category" value={recipeData.category} onChange={handleInputChange}>
        ...
        {recipeData.ingredients.map((ingredient, index) => (
          <div key={index}>
            ...
            <select
              ...
              onChange={(e) => handleIngredientChange(e, index)} >
              {["- -", "kg", "g", "mg", "l", "cl", "ml", "c.à.s"].map((unit, unitIndex) => (
      ...
      <div>
        <span>
          ...
          {["vegetarian", "gluten_free", "lazy", "dairy_free", "fish", "salad", "vegan", "meat",].map((oneProfile, i) => (
            <label key={i} name="profile">
              <input required type="checkbox" name={oneProfile} onChange={handleProfileChange}
              />
              {oneProfile}
            </label>
          ))}
      ...
      <div>
        <button type="submit" onClick={handleSubmit}>Ajouter la recette</button>
      </div>
    </form>
  );
};
